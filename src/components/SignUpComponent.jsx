    ...
    <div>
      <div className="card">
        ...
        <div className="logInWithGoogle">
            <GoogleButton   label='Sign up with Google' className="googleButton" onClick={googleSignIn} />
        </div>
        <p className="signup">already have an account? <span onClick={() => navigate("/")}>SignIn</span> </p>
      </div>
    </div>
  )
}
